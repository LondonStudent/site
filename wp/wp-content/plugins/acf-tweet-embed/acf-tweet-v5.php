	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Tweet embed', 'acf-tweet');
...
require_once('TwitterAPIExchange.php');
		...
		$getfield = '?url=' . $value . '&omit_script=true';
		$requestMethod = 'GET';
		...
		wp_enqueue_script( 'twitter-embed-js', 'https://platform.twitter.com/widgets.js', array(), '1.0.0', true );
