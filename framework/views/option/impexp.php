<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		...
		<div class="description">
			<p><?php _e('Import Options', 'alaya') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'alaya') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		...
		<div class="description">
			<p><?php _e('Export Options', 'alaya') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'alaya') ?>" />
				<span style="margin-left: 10px;">
