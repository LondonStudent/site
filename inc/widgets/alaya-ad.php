...
class alaya_ad extends WP_Widget {
	...
	**/
	public function __construct() {
		...
		parent::__construct(
	 		'alaya_ad', // Base ID
			__( '(CityNews) Advertisement', 'alaya' ), // Name
			array( 'description' => __( 'Add single image banner', 'alaya' ), ) // Args
		);
	...
	**/
	public function widget( $args, $instance ) {
        ...
        <a href="<?php echo esc_url($banner_link); ?>" rel="nofollow" target="_blank">
	...
	**/
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner_url' ); ?>"><?php _e('Image Banner URL:', 'alaya'); ?></label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'banner_link' ); ?>"><?php _e('Image Banner Link:', 'alaya'); ?></label>
        ...
        <p>
			...
			<label for="<?php echo $this->get_field_id( 'hide_title' ); ?>"><?php _e( 'Do not display the title', 'alaya' ); ?></label>
		</p>
	<?php
	}

}
register_widget( 'alaya_ad' );